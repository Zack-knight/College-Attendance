...
const FacultyDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-200 via-cyan-100 to-white p-0">
      {/* Navbar */}
      <nav className="w-full fixed top-0 z-50 bg-white/60 backdrop-blur-md shadow-md px-8 py-4 flex justify-between items-center border-b border-white/30">
        ...
        <div className="flex space-x-6 font-medium text-gray-700">
          ...
          <Link to="/register" className="hover:text-teal-600 transition">Register</Link>
